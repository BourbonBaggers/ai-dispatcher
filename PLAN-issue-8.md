...
## [DONE] Milestone 1: state — add `deployEscalated` to RunRecord
...
## [DONE] Milestone 2: autoship — escalate the ship-failure path
...
## [DONE] Milestone 3: dispatcher — wire the escalation relaunch
